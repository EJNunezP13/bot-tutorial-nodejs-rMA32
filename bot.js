...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      botRegex = /^\/cool guy/;  botRegexDL = /^\/DDL/i;botRegexSalt = /^\/salt/;botRegexRules = /^\/rules/;botRegexYoutube = /^\/youtube/
      ...
      botRegexDaf = /^\/dafuq/; botRegexMA32 = /^\/pending/; botRegexTrade = /^\/trade/; botRegexTeam = /^\/team/;
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("https://docs.google.com/document/d/1LmcXFUJS3Q5-d_um_8xYgWVSBFn4muA1InVS2QS54x8/edit?usp=sharing");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("https://youtu.be/5LEQrKPxeE0");
    this.res.end();
  } 
